...
def test_include_task():
    ...
    assert newt.include_task(cfg, "task1", "cluster1", "subcluster1") is True  # Matches cluster
    assert newt.include_task(cfg, "task1", "cluster2", "subcluster2") is True  # Matches subcluster
    assert newt.include_task(cfg, "task2", "cluster2", "subcluster3") is True  # Matches task
    assert newt.include_task(cfg, "task3", "cluster3", "subcluster3") is False  # Matches none
